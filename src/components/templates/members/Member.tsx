...
export default function Member({image, first_name, role, email, phone}:Member_TP) {
    return (
            ...
            <div className="info flex flex-col gap-[5px] lg:flex-row">
                <div className='flex-1 flex flex-col gap-[5px] lg:border-r border-[#1A3645] lg:pr-[5px]'>
                    <div className='flex gap-[5px] items-center'>
                        ...
                        <p className=' font-bold text-[12px] text-[#1A3645]'>{first_name}</p>
                    </div>
                    <div className='flex gap-[5px] items-center'>
                        <BsBriefcaseFill className='text-[#1A3645]'/>
                        <p className='  text-[12px] text-[#1A3645]'>{role}</p>
                    </div>
                </div>
